...
public class MatchTest {
    ...
    @Test
    public void addPointsParticipant1() throws Exception {
        Match match = new Match(new Participant("Tester1"),new Participant("Tester3"),"123");
    ...
    @Test
    public void addPointsParticipant2() throws Exception {
        Match match = new Match(new Participant("Tester1"),new Participant("Tester3"),"123");
    ...
    @Test
    public void removePointsParticipant1() throws Exception {
        Match match = new Match(new Participant("Tester1"),new Participant("Tester3"),"123");
    ...
    @Test
    public void removePointsParticipant2() throws Exception {
        Match match = new Match(new Participant("Tester1"),new Participant("Tester3"),"123");
    ...
    @Test
    public void getPointsParticipant1() throws Exception {
        Match match = new Match(new Participant("Tester1"),new Participant("Tester3"),"123");
    ...
    @Test
    public void getPointsParticipant2() throws Exception {
        Match match = new Match(new Participant("Tester1"),new Participant("Tester3"),"123");
